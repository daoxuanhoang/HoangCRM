...
@section('caption', 'Sửa bán hàng')

@section('title', 'Sửa bán hàng')
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group input-row">
                                {{ Form::label('product_id', 'Sản phẩm được chỉ định') }}
                        ...
                        <div class="col-lg-6">
                            <div class="form-group input-row">
                                <div class="form-group input-row">
                                    {{ Form::label('quantity', 'Số lượng') }}
                                    <div class="input-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('date_of_payment', 'Ngày thanh toán') }}
                                <div class="input-group">
                        ...
                        <div class="col-lg-12 validate_form">
                            {{ Form::submit('Sửa bán hàng', ['class' => 'btn btn-primary']) }}
                        </div>
