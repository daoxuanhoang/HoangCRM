...
@section('caption', 'Danh sách bán hàng')

@section('title', 'Danh sách bán hàng')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ URL::to('sales/form/create') }}">
                <button type="button" class="btn btn-primary btn active">Thêm bán hàng</button>
            </a>
            <br><br>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-keyboard-o" aria-hidden="true"></i> Danh sách bán hàng
                </div>
                    ...
                    <div class="table">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-sortable>
                            ...
                            <tr>
                                ...
                                <th class="text-center">Sản phẩm</th>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group">
                                            <a class="btn btn-small btn-primary"
                                               href="{{ URL::to('sales/view/' . $value->id) }}">Thêm thông tin</a>
                                            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle"><span class="caret"></span></button>
                                            <ul class="dropdown-menu">
                                                <li><a href="{{ URL::to('sales/form/update/' . $value->id) }}">Sửa</a></li>
                                                <li class="divider"></li>
