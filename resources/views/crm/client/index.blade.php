...
@section('caption', 'Danh sách khách hàng')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ URL::to('clients/form/create') }}">
                <button type="button" class="btn btn-primary btn active">Thêm khách hàng</button>
            </a>
            <br><br>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-users" aria-hidden="true"></i> Danh sách khách hàng
                    </div>
                        ...
                        <div class="table">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-sortable>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Ngân sách</th>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <a class="btn btn-small btn-primary"
                                                   href="{{ URL::to('clients/view/' . $value->id) }}">Thêm thông tin</a>
                                                <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle"><span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="{{ URL::to('clients/form/update/' . $value->id) }}">Sửa</a></li>
                                                    <li class="divider"></li>
