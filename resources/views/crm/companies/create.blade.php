...
@section('content')
    @if(count($dataWithPluckOfClient) == 0)
        <div class="alert alert-danger">
            <strong>Danger!</strong> Không có trong hệ thống. Vui lòng tạo bất kỳ khách hàng nào. <a href="{{ URL::to('client/create') }}">Click here!</a>
        </div>
    @endif
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 validate_form">
                            {{ Form::submit('Thêm công ty', ['class' => 'btn btn-primary']) }}
                        </div>
