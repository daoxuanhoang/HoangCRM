...
@section('caption', 'Sửa giao dịch')

@section('title', 'Sửa giao dịch')
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            {{ Form::model($deal, ['route' => ['processUpdateDeal', $deal->id], 'method' => 'PUT']) }}
                        ...
                        <div class="col-lg-12 validate_form">
                            {{ Form::submit('Sửa giao dịch', ['class' => 'btn btn-primary']) }}
                        </div>
