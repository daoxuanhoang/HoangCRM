...
@section('caption', 'Thêm giao dịch')

@section('title', 'Thêm giao dịch')
...
@section('content')
    @if(count($dataOfDeals) == 0)
        <div class="alert alert-danger">
            <strong>Danger!</strong> Không có công ty nào trong hệ thống. Hãy tạo một cái. <a
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group input-row">
                                {{ Form::label('start_time', 'Ngày bắt đầu') }}
                                <div class="input-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group input-row">
                                {{ Form::label('end_time', 'Ngày kết thúc') }}
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            ...
                            <div class="form-group input-row">
                                {{ Form::label('companies_id', 'Thỏa thuận giữa công ty:') }}
                                <div class="input-group">
                        ...
                        <div class="col-lg-12 validate_form">
                            {{ Form::submit('Thêm giao dịch', ['class' => 'btn btn-primary']) }}
                        </div>
                    {{ Form::close() }}
                    </div>
                </div>
