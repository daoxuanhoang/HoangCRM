...
@section('caption', 'Thêm nhân viên')
...
@section('content')
    @if(count($dataOfClients) == 0)
        <div class="alert alert-danger">
            <strong>Danger!</strong> Không có khách hàng trong hệ thống. Hãy tạo một cái. <a
                    href="{{ URL::to('client/create') }}">Bấm vào đây!</a>
        </div>
    @endif
