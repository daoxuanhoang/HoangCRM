...
@section('caption', 'Sửa tài chính')

@section('title', 'Sửa tài chính')
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            {{ Form::model($finance, ['route' => ['processUpdateFinance', $finance->id], 'method' => 'PUT']) }}
                        ...
                        <div class="col-lg-12 validate_form">
                            {{ Form::submit('Sửa tài chính', ['class' => 'btn btn-primary']) }}
                        </div>
                        {{ Form::close() }}
                    </div>
                </div>
