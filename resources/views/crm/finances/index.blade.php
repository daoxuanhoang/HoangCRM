...
@section('caption', 'Danh sách tài chính ')

@section('title', 'Danh sách tài chính')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ URL::to('finances/form/create') }}">
                <button type="button" class="btn btn-primary btn active">Thêm tài chính</button>
            </a>
            <br><br>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-code-fork" aria-hidden="true"></i> Danh sách tài chính
                </div>
                    ...
                    <div class="table">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-sortable>
                            ...
                            <tr>
                                ...
                                <th class="text-center">Kiểu</th>
                                <th class="text-center">Tổng</th>
                                <th class="text-center">Net</th>
                                <th class="text-center">Vat</th>
                                <th class="text-center">Các công ty được chỉ định</th>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group">
                                            <a class="btn btn-small btn-primary"
                                               href="{{ URL::to('finances/view/' . $value->id) }}">Thêm thông tin</a>
                                            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle"><span class="caret"></span></button>
                                            <ul class="dropdown-menu">
                                                <li><a href="{{ URL::to('finances/form/update/' . $value->id) }}">Sửa</a></li>
                                                <li class="divider"></li>
                                                <li><a href="#">Một vài tùy chọn</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
